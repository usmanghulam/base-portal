...
const items = [
  {
    ...
    description: 'Curabitur porta nisl in arcu condimentum fermentum. Nunc nec bibendum nulla. Etiam maximus neque mi, vitae aliquet ex tristique vel. In viverra augue ex.'
  },
  {
    img: 'src/assets/images/homeImage/Vendor.png',
    src: 'src/assets/images/homeImage/Payments.png',
