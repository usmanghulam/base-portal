...
const arrayOfObjects = [
    {
        ...
        alt: '',
        data:
            { content: 'Total Amount Disbursed', size: '500,000,000' }
    },
    {
        src: `${url}_Group_.png`,
        alt: '',
        ...
        <>
            ...
            <StyledFeature>
                {arrayOfObjects.map((item, index) => (
                    <Grid key={index} display='flex' justifyContent='space-around' alignItems='center' flexWrap='wrap'>
                        <Grid marginTop={6}>
                            <img src={item.src} alt="" style={{ border: '2px rgba(94, 220, 181, 0.12)', backgroundColor: 'rgba(94, 220, 181, 0.12)', padding: '6px' }} />
                            <Grid marginTop={4}>
                                <Typography variant='h6' fontSize={14} >{item.data.content}</Typography>
                            </Grid>
                        </Grid>
                        <Grid>
